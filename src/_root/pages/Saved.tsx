...
const Saved = () => {
  ...
  const categories = savedPosts
    ? [...new Set(savedPosts.flatMap((post) => post.tags || []))]
    : [];
          ...
          <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
            ...
            <div className='flex items-center gap-2'>
              <Button
                variant='outline'
                size='sm'
                className={`p-2 hover:bg-dark-4 transition-colors ${
                  activeView === 'grid'
                    ? 'bg-dark-3 border-primary-500 text-primary-500'
                    : 'border-dark-4 text-light-2'
                }`}
            ...
            {isFilterOpen && categories.length > 0 && (
              ...
              >
                <div className='bg-dark-2 rounded-xl p-4 border border-dark-4'>
                  <h3 className='text-light-1 font-medium mb-3'>
                    Filter by tag:
                  </h3>
              ...
              >
                ...
                <div className='text-center'>
                  ...
                  <p className='text-light-3 mb-6 max-w-md'>
                    Save posts you'd like to revisit by clicking the bookmark
                    icon on any post you enjoy.
                  </p>
                  <Link to='/explore'>
              ...
              >
                ...
                <div className='text-center'>
                  ...
                  <p className='text-light-3 mb-4'>
                    We couldn't find any saved posts matching your search for "
...
// List view component for posts with square images and smaller caption
      ...
      {posts.map((post) => (
        ...
        >
          <div className='flex flex-col md:flex-row h-full'>
            ...
            <div className='md:w-64 md:h-64 aspect-square overflow-hidden flex-shrink-0'>
              ...
              <div>
                ...
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  >
                    ...
                    />
                    <div>
                      <p className='font-medium text-light-1 text-sm'>
                        {post.creator.name}
                      </p>
                ...
                {/* Post caption with reduced font size */}
                <Link to={`/posts/${post.$id}`}>
                  <h3 className='text-base font-medium text-light-1 mb-2 line-clamp-2 hover:text-primary-500 transition-colors'>
                    {post.caption}
                  </h3>
                </Link>
                ...
                {post.tags && post.tags.length > 0 && (
                  <div className='flex flex-wrap gap-2 mt-3'>
                    {post.tags.map((tag: string) => (
                      <span
                        key={tag}
                        className='text-xs text-light-3 bg-dark-3 px-2 py-1 rounded-full'
                      >
                        #{tag}
                      </span>
                    ))}
