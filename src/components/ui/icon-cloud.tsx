...
export function IconCloud({
  ...
  // Use useRef for rotation state to avoid the unused useState declaration warning
      ...
      if (offCtx) {
        if (images) {
          ...
          img.onload = () => {
            ...
            // Draw the image at original colors (no filter)
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Sort icons by z-depth for proper rendering
